...
function Strategy(options, verify) {
  ...
  const allowedToFetchProfile = this._scope.includes('identity.basic') || this._scope.includes('bot')
  // warn is not enough scope
  // Details on Slack's identity scope - https://api.slack.com/methods/users.identity
  if(!this._skipUserProfile && !allowedToFetchProfile){
    console.warn("Scope 'identity.basic' or 'bot' is required to retrieve Slack user profile");
  }
}
